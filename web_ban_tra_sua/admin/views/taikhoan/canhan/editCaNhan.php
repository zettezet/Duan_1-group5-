                        ...
                        <div class="col-md-9">
                            <form action="<?= BASE_URL_ADMIN . '?act=sua-thong-tin-ca-nhan-quan-tri' ?>" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="firstname" value="Jane">
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Last name</label>
                                    <input class="form-control" type="text" name="lastname" value="Bishop">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="email" name="email" value="janesmail@gmail.com">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="timezone" class="form-control">
                                        ...
                                        <option value="Central" selected>(GMT-06:00) Central Time</option>
                                    </select>
                                </div>
